package com.flchy.cloud.miniapp.wechat.mp.config;
...
import com.flchy.cloud.miniapp.wechat.mp.handler.*;
...
public class WxMpConfiguration {
    ...
    public WxMpService wxMpService() {
        ...
        List<MinAppConfig> configs = iMinAppConfigService.queryAll(MimiAppTypeEnum.WECHAT_PUBLIC);
...
//                    WxMpDefaultConfigImpl configStorage = new WxMpDefaultConfigImpl();
                    WxMpDefaultConfigImpl configStorage = new WxMpRedisConfigImpl(jedisPool);
                    configStorage.setAppId(a.getId());
